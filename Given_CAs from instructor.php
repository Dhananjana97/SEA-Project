...
?>
    ...
    <input type='button' style="margin-left:75%;border:none;color:white;background-color:black;padding:15px 32px;"
           onclick="location.href='add new CA.php?module=<?php echo "$CA_module" ?>'" value='Add New CA'>
