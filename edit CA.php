            ...
            <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                <div class="panel panel-danger">
                    <div class="panel-body">
                        ...
                        <form id="reused_form"
                              action=<?php echo "'edit CA process.php?module=$module&CA_number={$CA_number}&submitted_file={$submitted_file}'"; ?>          method="Post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="message" class="form-control"
                                          placeholder="Type Your Message"><?php echo "$Assignment"; ?></textarea>
                            </div>
                            <div class="form-group">
...
<?php //echo " document.getElementById('logo').innerHTML='".remove_file_path($g[1])."';";
                                ...
                                <div>
                                    <button type="submit" name='submit' class="form-submit-button"
                                            style="margin-bottom:30px;">Submit
                                    </button>
                                </div>
                                <br>
