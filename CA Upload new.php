            ...
            <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                <div class="panel panel-danger">
                    <div class="panel-body">
                        ...
                        <form id="reused_form"
                              action=<?php echo "CA Upload.php?module=$CA_module&ca_number=$CA_number&submitted_file=$g[1]"; ?> method="Post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="message" class="form-control"
                                          placeholder="Type Your Message"><?php echo "$g[0]"; ?></textarea>
                            </div>
                            <div>
                                ...
                                <div style="width:100%;height:230px;background-color:white;">
                                    ...
                                    <div>
                                        <button style="margin-left:75%;" onclick="">remove</button>
                                    </div>
