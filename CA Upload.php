            ...
            <div class="">
                <div class="panel panel-danger">
                    <div class="panel-body">
                        ...
                        <form id="reused_form" style="border:2px;"
                              action=<?php echo "'CA Upload Process.php?module=$CA_module&ca_number=$CA_number&submitted_file=$g[1]&task=$task&task_file=$task_file&closing_time=$closing_time'"; ?> method="Post"
                              enctype="multipart/form-data">


                            <p style="font-weight:bold;font-size:20px;"> <?php echo "Download"; ?><a
                                        href="<?php echo "$task_file" ?> ">This File</a>
                                <?php echo "$task"; ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="message" class="form-control" placeholder="Type Your Message"
                                          style="width:500px;"><?php echo "$g[0]"; ?></textarea>
                            </div>
                            <div>
...
<?php //echo " document.getElementById('logo').innerHTML='".remove_file_path($g[1])."';";
                                ...
                                <br>
                                <div>
                                    <button type="submit" name='submit' class="form-submit-button"
                                            style="margin-bottom:50px;">Submit
                                    </button>
                                </div>
                                <br>
